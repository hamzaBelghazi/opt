...
exports.addGlassTocart = exports.addGlassesWithLenses = exports.incsDecQuantity = exports.deleteItemFromCart = void 0;
...
var addGlassesWithLenses = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(lensesOpt, itemId) {
    var res;
  ...
  return function addGlassesWithLenses(_x4, _x5) {
...
var addGlassTocart = /*#__PURE__*/function () {
  ...
  return function addGlassTocart(_x6) {
...
exports.sendVerToken = exports.setNewPassword = exports.deleteFav = exports.addNewFav = exports.addNewVert = exports.addNewProduct = exports.updateLensesSet = exports.addNewPage = exports.deletePage = exports.deleteAnnounce = exports.addNewAnnounce = exports.deleteCategory = exports.addNewCategory = exports.deleteCollection = exports.addNewcollection = exports.deleteOrder = exports.CompletOrder = exports.removeProduct = exports.removeBanner = exports.addBanner = exports.updateSettings = void 0;
...
var bannerContainer = document.querySelector('.old_banners');
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              bannerHtml = "\n      <div class=\"old-banner\">\n        <img class=\"old_banner_img\" src=\"/img/banners/".concat(res.data.data.data.slide, "\" alt='").concat(res.data.data.data.link, "'>\n        <span class=\"delete_old_banner\" data-banner='").concat(res.data.data.data._id, "'>x</span>\n      </div>\n      \n      ");
        ...
        switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              html = "\n      <div class=\"old-banner\">\n        <img class=\"old_banner_img\" src=\"/img/collection/".concat(res.data.data.data.collectionImage, "\" alt='").concat(res.data.data.data.name, "'>\n        <span class=\"delete_old_collection\" data-id='").concat(res.data.data.data._id, "'>x</span>\n      </div>\n      ");
        ...
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              html = "\n      <div class=\"old-banner\">\n        <img class=\"old_banner_img\" src=\"/img/category/".concat(res.data.data.data.categoryImage, "\" alt='").concat(res.data.data.data.name, "'>\n        <span class=\"delete_old_category\" data-id='").concat(res.data.data.data._id, "'>x</span>\n      </div>\n      ");
        ...
        switch (_context11.prev = _context11.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              html = "\n      <div class='announce'>\n        <span class=\"announce--body\">\n          ".concat(res.data.data.data.announceText, "\n        </span>\n        <span class=\"announce--delete\" data-id='").concat(res.data.data.data.id, "''>x</span>\n      </div>\n\n      ");
        ...
        switch (_context14.prev = _context14.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              html = "\n      <div class='page'>\n        <span class=\"old_page_name\">\n          ".concat(res.data.data.data.name, "\n        </span>\n        <span class=\"delete_old_page\" data-id='").concat(res.data.data.data.id, "''>x</span>\n      </div>\n\n      ");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'your not logged in please signin Or rejister an acount');
            setTimeout(function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            spinnerLoader();
            _context.next = 5;
            return (0, _axios.default)("/api/products?limit=3&".concat(filterObj));
          ...
          case 9:
            ...
            return _context.abrupt("return", spinnerhidd());
...
var addFavBtn = document.querySelector('.add_fav');
var DeleteFavBtn = document.querySelector('.delete_fav');
...
if (addSimpleToCart) {
  addSimpleToCart.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _cart.addGlassesWithLenses)(lensesCart, e.target.dataset.id);
  });
}
...
if (BannerDeleteBtn) {
  BannerDeleteBtn.forEach(function (b) {
    b.addEventListener('click', function (e) {
      ...
      (0, _updateSettings.removeBanner)(banner);
...
if (pageDataForm) {
  pageDataForm.addEventListener('submit', function (e) {
    ...
    var pageBody = CKEDITOR.instances.text_editor.getData();
    (0, _updateSettings.addNewPage)(name, pageBody);
    e.target.reset();
  });
}
...
if (addFavBtn) {
  addFavBtn.addEventListener('click', function (e) {
    var _e$target$dataset = e.target.dataset,
        product = _e$target$dataset.product,
        user = _e$target$dataset.user;
